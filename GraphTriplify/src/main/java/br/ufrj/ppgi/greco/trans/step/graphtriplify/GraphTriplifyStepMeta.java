...
import br.ufrj.ppgi.greco.trans.step.graphtriplify.GraphTriplifyStep;
import br.ufrj.ppgi.greco.trans.step.graphtriplify.GraphTriplifyStepData;
import br.ufrj.ppgi.greco.trans.step.graphtriplify.GraphTriplifyStepDialog;
 ...
 * 
 */
public class GraphTriplifyStepMeta extends BaseStepMeta implements
        StepMetaInterface
{
    public enum Field
    {
    ...
    {
        return new GraphTriplifyStep(stepMeta, stepDataInterface, copyNr,
                transMeta, trans);
    }
