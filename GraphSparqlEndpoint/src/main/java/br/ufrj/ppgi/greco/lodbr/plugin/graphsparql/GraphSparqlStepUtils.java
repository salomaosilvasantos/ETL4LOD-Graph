 ...
 * @author Expedito
 */
public class GraphSparqlStepUtils
{
    ...
    public static String toPrefixesString(List<List<String>> prefixes)
    {
        ...
        for (List<String> row : prefixes)
        {
            ...
            if (prefix != null && namespace != null && !prefix.equals("")
                    && !namespace.equals(""))
            {
                sb.append("PREFIX ");
                sb.append(row.get(0));
     ...
     */
    public static String toFullQueryString(List<List<String>> prefixes,
            String queryString)
    {
     ...
     * @return
     */
    public static List<ValueMetaInterface> generateOutputVars(String varPrefix,
            String queryString)
    {
        try
        {
            ...
            switch (query.getQueryType())
            {
                case Query.QueryTypeAsk:
                    outVars.add(new ValueMeta(varPrefix + "ask",
                            ValueMetaInterface.TYPE_BOOLEAN));
                    break;

                case Query.QueryTypeConstruct:
                case Query.QueryTypeDescribe:
                    outVars.add(new ValueMeta(varPrefix + "subject",
                            ValueMetaInterface.TYPE_STRING));
                    outVars.add(new ValueMeta(varPrefix + "predicate",
                            ValueMetaInterface.TYPE_STRING));
                    outVars.add(new ValueMeta(varPrefix + "object",
                            ValueMetaInterface.TYPE_STRING));
                    break;
                ...
                case Query.QueryTypeSelect:
                    ...
                    for (String s : vars)
                    {
                        outVars.add(new ValueMeta(varPrefix + s,
                                ValueMetaInterface.TYPE_STRING));
                    }
                    break;
            }
     ...
     * @return
     */
    public static QueryExecution createQueryExecution(Query query,
            String endpointUri, String defaultGraph)
    {
