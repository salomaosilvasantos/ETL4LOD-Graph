 ...
 * 
 * Change:
 * Step grain changed to subjectItem (resource and its properties) 
 * instead of the resultRDF Graph result from CONSTRUCT sparql command
 * 
 * @author Kelli
 */
public class GraphSparqlStep extends BaseStep implements StepInterface
{
    ...
    public GraphSparqlStep(StepMeta stepMeta, StepDataInterface stepDataInterface,
            ...
            throws KettleException
    {
        ...
        if (first)
        {
            ...
            String queryStr = GraphSparqlStepUtils.toFullQueryString(
    ...
    // Rogers(Nov/2012): Correcao de bug na ordenacao dos campos da consulta
    // SPARQL
    private int runQueryAndPutResults(Query query, GraphSparqlStepMeta meta,
            GraphSparqlStepData data, Object[] row) throws KettleStepException
    {
        int numPutRows = 0;
        QueryExecution qexec = GraphSparqlStepUtils.createQueryExecution(query,
